...
export function SkillInfiniteMovingCards() {
  return (
    <BackgroundBeamsWithCollision>
      <div className="h-160 rounded-md flex flex-col antialiased bg-transparent items-center justify-center relative overflow-hidden">
